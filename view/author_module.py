...
class AuthorModule(tk.Toplevel):
    ...
    def register_author(self):
        ...
        if not AuthorValidator.validate_author_id(author_id):
            messagebox.showerror("Validation Error", "Invalid Author ID. Must be numeric.")
            return
    ...
    def delete_author(self):
        if not self.selected_author_id:
            messagebox.showwarning("Warning", "Select an author to delete.")
            return

        confirm = messagebox.askyesno("Confirm Delete", "Are you sure you to delete this author?")
        if not confirm:
            return
    ...
    def load_authors(self):
        ...
        try:
            ...
            messagebox.showerror("Error", f"Failed to load authors: {e}")
